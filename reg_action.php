...
$voter = mysqli_real_escape_string($con,$_POST['voterId']);
...
$sql = mysqli_query($con, 'INSERT INTO voters(firstname,lastname,voterId,username)
         VALUES("'.$_POST['firstname'].'","'.$_POST['lastname'].'","'.$_POST['voterId'].'","'.$_POST['username'].'")');
		 if (!$sql) { 
